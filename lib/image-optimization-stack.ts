...
var S3_IMAGE_BUCKET_NAME: string = process.env
  .originalImageBucketName as string;  //evfy.bucket1
  ...
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    if (S3_IMAGE_BUCKET_NAME) {
      ...
      originalImageBucket = new s3.Bucket(
        ...
        {
          bucketName: process.env.originalImageBucketName,
    ...
    const s3ReadOriginalImagesPolicy = new iam.PolicyStatement({
      ...
      resources: ["arn:aws:s3:::" + originalImageBucket.bucketName + "/*", "arn:aws:s3:::" + originalImageBucket.bucketName],
    });
